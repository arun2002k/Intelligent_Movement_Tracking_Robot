// Intelligent Movement Tracking Robot
// Mini project
// All you need is Arduino UNO, Motor Driver Board, Servo Motor, DC motors (Qty = 4)
// Wheels (Qty = 4), 9V Battery (Qty = 2), IR sensor (Qty = 2), UltraSonic sensor (Qty = 1)
...
#define RIGHT A2              // Right IR sensor to analog pin A2 of Arduino
#define LEFT A3               // Left IR sensor to analog pin A3 of Arduino 
#define TRIGGER_PIN A1        // Trigger pin to analog pin A1 of Arduino 
#define ECHO_PIN A0           // Echo pin to analog pin A0 of Arduino 
#define MAX_DISTANCE 200      // Maximum ping distance

unsigned int distance = 0;    // ultrasonic sensor distance
unsigned int Right_Value = 0; // Right IR sensor value
unsigned int Left_Value = 0;  // Left IR sensor value
...
void setup() { // the setup function runs only once when power on the board or reset the board
   ...
   myservo.attach(10); // servo to pin 10 of Arduino
{
